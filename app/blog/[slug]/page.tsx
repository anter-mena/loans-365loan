...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  const base = buildMetadata({
    title: `${post.meta.title} | 365loan`,
    description: post.meta.description,
    path: `/blog/${slug}`,
    keywords: post.meta.keywords.length
      ? post.meta.keywords
      : [post.meta.title.toLowerCase(), "personal loan canada", "365loan blog"],
  });
    ...
    <>
      ...
      <section className="bg-background pt-20 lg:pt-24">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <RelatedClusters exclude="/blog" heading="Explore Your Loan Options" />
        </div>
      </section>
